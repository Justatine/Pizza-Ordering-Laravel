          ...
          <div class="container-wrap">
              <div class="row no-gutters d-flex">
                @foreach ($products as $product)
                    <div class="col-lg-4 d-flex ftco-animate mt-2">
                        <div class="services-wrap d-flex">
                            <a href="#" class="img" style="background-image: url(images/products/{{ $product->image ?? 'default.png' }});"></a>
                            <div class="text p-4">
                                <h3>{{ $product->name }}</h3>
                                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia </p>
                                <p class="price"><span>₱ {{ $product->price }}</span> 
                                    <a href="{{ url('/menu/'.$product->productId) }}" class="ml-2 btn btn-white btn-outline-white"><i class="fa fa-cart"></i> Order</a></p>
                            </div>
                        </div>
                    </div>
                @endforeach
