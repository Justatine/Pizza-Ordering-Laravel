            ...
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    ...
                    <div class="site-section w-100 mt-5" data-aos="fade-up" data-aos-delay="0.3s">
                        <form class="py-5 px-5 border" method="POST" action="{{ url('/admin/users/new/store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" class="form-control" placeholder="Enter phone number" minlength="11" maxlength="11" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="name">Address: </label>
                                                <textarea name="address" cols="30" rows="5" placeholder="Province/City/Street/Barangay" class="form-control" required></textarea>
                                            </div>
                                        </div>
                                    </div>
